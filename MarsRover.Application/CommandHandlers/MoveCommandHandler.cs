...
{
    public class MoveCommandHandler : CommandHandler<RoverAggregate, Identity, IExecutionResult, MoveCommand>
    {
        public override async Task<IExecutionResult> ExecuteCommandAsync(RoverAggregate aggregate, MoveCommand command, CancellationToken cancellationToken)
        {
