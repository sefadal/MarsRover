...
{
    public class LocationAggregate : AggregateRoot<LocationAggregate, Identity>
    {
        public LocationAggregate(Identity id) : base(id)
        { }
        ...
        public IExecutionResult Initialize(string surfaceSizeInput)
        {
            ...
            Emit(new InitializeSizeEvent(surfaceSize));
        ...
        public void Apply(InitializeSizeEvent aggregateEvent)
        {
